...
class Check_Similarity:
    ...
    def pre_processing_string(value_to_processing):
        ...
        if isinstance(value_to_processing, str):
            ...
            value_processing = [
                str(value).lower().strip() for value in value_to_processing
            ]
    ...
    @staticmethod
    @validate_arguments
    def get_values_similarity(
        query: str, choices: Union[str, list], pre_processing=False, limit=5
    ):
